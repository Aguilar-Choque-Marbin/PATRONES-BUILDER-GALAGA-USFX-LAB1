...
{	
	...
	ShipMeshComponent->OnComponentHit.AddDynamic(this, &AGalaga_USFX_L02Pawn::OnHit);
...
void AGalaga_USFX_L02Pawn::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
